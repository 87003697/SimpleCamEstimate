...
def check_environment():
    ...
    try:
        ...
        print(f"   ❌ camera_search package import failed: {e}")
        return False
    ...
    try:
        ...
        print("   ❌ nvdiffrast not available (required dependency)")
        return False
    ...
    try:
        ...
        print("   ❌ kiui not available (required dependency)")
        return False
    ...
    try:
        ...
        print("   ⚠️ matplotlib not available, visualization features will be limited")
...
def run_single_scene_test(scene_name: str, use_model: str = 'none', enable_visualization: bool = True) -> bool:
    ...
    try:
        ...
        if use_model == 'vggt':
            ...
            print(f"   🔄 Switched to VGGT mode")
        elif use_model == 'dust3r':
            searcher.config['use_vggt'] = False
        ...
        try:
            ...
            elapsed = time.time() - start_time
            print(f"   ❌ Algorithm failed after {elapsed:.1f}s: {e}")
            return False
    ...
    try:
        ...
        for i, data_pair in enumerate(test_scenes):
            ...
            try:
                ...
                print(f"   ❌ Scene {data_pair.scene_name} failed: {e}")
                results[data_pair.scene_name] = None
        ...
        if create_batch_summary and enable_visualization:
            try:
                ...
                print(f"   ⚠️ Batch summary generation failed: {e}")
...
def main():
    ...
    parser.add_argument('--use-model', type=str, choices=['vggt', 'dust3r', 'none'], default='none', 
    ...
    if passed_tests == total_tests:
        ...
        print(f"   python test.py --single-scene 'dancing_spiderman' --use-model vggt   # Use VGGT")
